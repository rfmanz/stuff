...
def lgb_regression(x_train, x_test, y_train, params, n_folds=5, plot_feature_importance=False, verbose=100,
                   early_stopping_rounds=100, num_boost_round=100):
...
for fold, (trn_idx, test_idx) in enumerate(kf.split(X, y)):
    ...
    clf = lgb.train(params, trn_data, 10000, valid_sets=[trn_data, val_data], verbose_eval=verbose,
